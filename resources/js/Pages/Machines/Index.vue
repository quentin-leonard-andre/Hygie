...
<template>
        ...
        <div class="overflow-x-auto mt-4">
                    ...
                    <tr v-for="machine in machines">
                        ...
                        <td class="text-center">
                            <div class="flex justify-end items-center gap-2">
                                <a class="btn btn-info" :href="route('machines.edit', {
                                    machine: machine.id
                                })">
                                ...
                                <form @submit.prevent="submit(machine.id)">
            ...
            <!-- Alerte si vide -->
            <div v-if="machines.length==0" class="alert alert-info shadow-lg my-3">
                <div>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" class="stroke-current flex-shrink-0 w-6 h-6"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                    <span>Aucune machine n'existe pour l'instant.</span>
                </div>
            </div>
        </div>
